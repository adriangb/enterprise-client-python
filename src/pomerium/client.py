...
from pomerium.pb.namespaces_pb2_grpc import (
    NamespacePermissionServiceStub,
...
from pomerium.pb.users_pb2_grpc import (
    PomeriumServiceAccountServiceStub,
    PomeriumSessionServiceStub,
    UserServiceStub,
)
...
class AuthMetadataPlugin(grpc.AuthMetadataPlugin):
    ...
    def __init__(self, auth_token):
        self._authorization_header = ("authorization", authorize_header(auth_token))
...
def _dial(
    ...
    return grpc.secure_channel(
        ...
        grpc.composite_channel_credentials(
            ...
            grpc.metadata_call_credentials(AuthMetadataPlugin(auth_token)),
        ),
        options=options,
    )
...
class Client(object):
    ...
    def __init__(
        ...
        self.NamespacePermissionService = NamespacePermissionServiceStub(self.channel)
        self.NamespaceService = NamespaceServiceStub(self.channel)
        self.PolicyService = PolicyServiceStub(self.channel)
        self.PomeriumServiceAccountService = PomeriumServiceAccountServiceStub(self.channel)
