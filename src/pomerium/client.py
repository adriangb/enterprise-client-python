...
def _dial(target: str, auth_token: str, root_certificates: bytes = None, private_key: bytes = None, certificate_chain: bytes = None):
...
class Client(object):
    ...
    def __init__(self, target: str, auth_token: str, root_certificates: bytes = None, private_key: bytes = None, certificate_chain: bytes = None):
